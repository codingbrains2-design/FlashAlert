                                                ...
                                                <form method="post" action="{{ route('validatecode') }}">
                                                        ...
                                                        <div class="tbl-input-email">
                                                            ...
                                                            @if ($datas1->Validated != 1)
                                                                <span class="text-danger">Validation email sent. <a
                                                                        href="{{ url('resendcode/' . $datas1->id) }}">Click
                                                                        here to send
                                                                ...
                                                                @endif
                                                                <label for="" class="form-label">Enter code from
                                                                    validation
                                                                    message</label>
                                                                <input class="form-control border" type="text"
                                                                    value="" name="validatedcode">
                                                                <span>Alerts are not sent to non-validated
                                                                    addresses.</span>
                                                            @endif
                                                        </div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <div class="tbl-btns">
                                                            ...
                                                            <a href="{{ url('sendtest/' . $datas1->id) }}"
                                                                class="btn btn-outline-primary">Send Test</a>
                                                            @if ($datas1->IsPrimary != 1)
...
>>>>>>> 798cc2b (clean)
                                ...
                                <div class="tbl-cautions mt-5">
                                    <ul style="font-size:10pt;">
                                        <li><span class="fw-6">Be aware that with the explosion of spam and the
                                                resulting
                                                spam filters, it is impossible to guarantee message delivery, since
                                                different
                                                filters block different messages. FlashAlert dispatches all messages
                                                within
                                                five
                                                minutes of being posting. Your email server and/or cell company may
                                                delay
                                                messages. Remember that text messages truncate after 150
                                                characters.</span>
                                        </li>
                                        <li><span class="fw-6"><em>Due to cell phone companies delaying or shortening
                                                    text
                                                    messages, we strongly discourage the use of cell text
                                                    numbers.</em></span><br>We encourage you to download the free
                                            Android/iOS
                                            phone/tablet app, FlashAlert Messenger, which uses push notification, a
                                            method
                                            <strong class="fw-6">much faster and more reliable</strong> than text
                                            messages
                                            (go to "My Linked Phone Apps" tab above).
                                        </li>
                                        <li>If you absolutely must get a text (i.e. no smartphone) and understand that
                                            support
                                            is not available for text addresses, you may enter it in the form of an
                                            email
                                            address. Click <a href="" target="_blank">here</a> for a list of
                                            formats by
                                            cell company.</li>
                                        <li>Note that if you register for news releases, they are sent to email
                                            addresses
                                            only,
                                            but can be viewed in the phone app.</li>
                                        <li>All addresses registered on FlashAlert will remain confidential. Each
                                            summer,
                                            you
                                            will receive a message at your primary email address asking if you wish to
                                            continue
                    ...
                    <div class="tab-pane msngr-pane p-4 border" id="tab-profile">
                        <div class="font-12"><strong class="fw-6">Your iOS and Android devices that have the
                                FlashAlert
                            ...
                            <p style="font-size:10pt;">The FlashAlert Messenger app allows you receive and view push
                                notifications on your tablet or smart phone. Push notifications are faster and more
                                reliable
                                than text messaging. <strong class="fw-6">If you get a new phone, you must delete the
                                    old
                                    one and add the new one (the notifications are sent based on the phone ID token, not
                                    the
                    ...
                    <div class="tab-pane msngr-pane p-4 border" id="tab-mysubscriptions">
                        ...
                        <div class="font-12">
                            <form method="post" action="{{ route('updatenewssubs') }}">
                                ...
                                @foreach ($org as $orgs)
                                    <div class="row">
                                        <input type="hidden" name="hidden_{{ $orgs->id }}"
                                            value="{{ @$orgs->id }}">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input" name="Ealertup_{{ $orgs->id }}"
                                                type="checkbox" value="1" id="flexCheckDefault_{{ $orgs->id }}"
                                        ...
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input" name="Nreleaseup_{{ $orgs->id }}"
                                                type="checkbox" value="1" id="flexCheckChecked_{{ $orgs->id }}"
                                        ...
                                        <div class="text-end">
                                            ...
                                            <a href="{{ url('deletesubscription/' . $orgs->id) }}"
                                                class="py-2 px-4 btn btn-primary text-white"
...
<<<<<<< HEAD
                    <div class="tab-pane msngr-pane p-4 border" id="tab-addsubscriptions">
                        ...
                        <p class="font-12">Please note that all schools & orgs use FlashAlert for media notifications,
                            but
                            not all offer a subscription option for the public.</p>

                        <strong class="fw-6 font-12">Find your org by <span class="text-danger">searching</span> by
                            Region
                            or
...
>>>>>>> 70ddfa705c446d98531632a5b1ed5e4d2fb060a1
                                ...
                                <div class="col-12 text-end mt-3">
                                    <button type="submit" class="py-2 px-4 text-white" style="display:none;"
...
>>>>>>> 798cc2b (clean)
                            ...
                            <div class="ml-4">
                                ...
                                <form method="post" action="{{ route('addsubscription') }}">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="Ealert" type="checkbox" value="1"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="Nrelease" type="checkbox" value="1"
                    ...
                    <div class="tab-pane msngr-pane p-4 border" id="tab-msngrsettings">
                        ...
                        <form method="post" action="{{ route('changePasswrd') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label for="" class="form-label fw-6">Confirm Password</label>
                                    <input class="form-control border" type="password" value=""
                            ...
                            <div class="del-account mt-3">
                                <p>Delete your FlashAlert account</p>
                                <a href="{{ url('deletesubscriptionaccount/' . session::get('ret')) }}"
                                    class="btn btn-danger p-3 text-white"
                                    onclick="return confirm('Are You Sure You want to Delete Account?')">Delete this
                                    Account</a>
                            </div>
                        </form>
...
>>>>>>> 351082b (maintain tab state msmnage page)
